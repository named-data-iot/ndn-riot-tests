...
extern const uint8_t service_discovery_test_ecc_prv_key[SECP256R1_PRV_KEY_SIZE];

extern const uint8_t service_discovery_test_ecc_pub_key[SECP256R1_PUB_KEY_SIZE];
